  ...
  try {
    ...
    grid.innerHTML = agents.map(agent => `
      <div class="agent-profile-card reveal">
        <img src="${escapeHtml(agent.imageUrl || 'images/agent1.jpg')}" alt="${escapeHtml(agent.name)}" onerror="this.src='images/agent1.jpg'" />
  ...
  try {
    ...
    grid.innerHTML = properties.map(prop => `
      <div class="featured-property-card reveal">
        <img src="${escapeHtml(prop.imageUrl || 'images/property1.jpg')}" alt="${escapeHtml(prop.title)}" onerror="this.src='images/property1.jpg'" />
